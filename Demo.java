...
public class Demo {
	...
	public static void main(String[] args) {
		...
		try
		{
		db1 = new DbTransaction("jdbc:oracle:thin:@INGNRGPILPHP01:1521:ORCLILP", "aja185core", "aja185core", "TBL_BOOK_1190848");
		//createMethod(db1);
		
		ArrayList<Book> ar = TestProcedure.getbooksListbyprice(db1);
		...
		{
			if(ar!=null)
			System.out.println("Book Id:-\t"+ar.get(i).getBookId()+"\tTitle:-\t"+ar.get(i).getTitle()+"\tPrice:-\t"+ar.get(i).getPrice()+"\tPages:-\t"+ar.get(i).getPages());
		}
		}catch (Exception e) {
			e.printStackTrace();
